<?xml version="1.0" encoding="UTF-8"?><schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <pattern id="UBL-modelaligned">
    ...
    <rule context="/ubl:Invoice | /cn:CreditNote">
      ...
      <assert id="aligned-ibrp-002-jp-sb" flag="fatal" test="/*/cbc:ProfileID and matches(normalize-space(/*/cbc:ProfileID), 'urn:fdc:peppol.eu:2017:poacc:selfbilling:01:1.0')">[aligned-ibrp-002-jp-sb]-Business process MUST be in the format 'urn:fdc:peppol.eu:2017:poacc:selfbilling:01:1.0'.</assert>
