...
<rule context="cac:TaxTotal">
    <assert id="aligned-ibr-jp-07-ntr" flag="fatal" test="//cbc:TaxAmount = 0">[aligned-ibr-jp-07-ntr]-Invoice total TAX amount in tax accounting currency (ibt-111), TAX category tax amount (ibt-117) and TAX category tax amount in accounting currency (ibt-190) MUST be 0 (zero).</assert>
</rule>
